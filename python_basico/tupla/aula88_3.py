...
print('Quantidade de caracter do item da linha 1, coluna 1:',(len(nomes[1][1])))
print('Quantidade de caracter do item da linha 1, coluna 1 e linha 1, coluna 2:',(len(nomes[1][1]) + len(nomes[1][2])))
